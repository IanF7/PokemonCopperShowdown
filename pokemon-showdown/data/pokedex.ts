export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	spearow: {
		...
		evos: ["Fearow"],
		eggGroups: ["Flying"],
		otherFormes: ["Spearow-Azorian"],
		formeOrder: ["Spearow", "Spearow-Azorian"],
	},
	spearowazorian: {
		num: 21,
		name: "Spearow-Azorian",
		baseSpecies: "Spearow",
		forme: "Azorian",
		types: ["Poison", "Flying"],
		baseStats: { hp: 40, atk: 85, def: 20, spa: 45, spd: 31, spe: 41 },
		abilities: { 0: "Keen Eye", H: "Poison Touch" },
		heightm: 0.3,
		weightkg: 2,
		color: "Black",
		eggGroups: ["Flying"],
	...
	fearow: {
		...
		evoLevel: 20,
		eggGroups: ["Flying"],
		otherFormes: ["Fearow-Azorian"],
		formeOrder: ["Fearow", "Fearow-Azorian"],
	},
	fearowazorian: {
		num: 22,
		name: "Fearow-Azorian",
		...
		forme: "Azorian",
		types: ["Poison", "Flying"],
		baseStats: { hp: 65, atk: 120, def: 55, spa: 75, spd: 51, spe: 76 },
		abilities: { 0: "Keen Eye", H: "Poison Touch" },
		heightm: 1.2,
		weightkg: 38,
		color: "Black",
	...
	poliwrathmega: {
		...
		forme: "Mega",
		types: ["Water", "Fighting"],
		baseStats: { hp: 90, atk: 135, def: 105, spa: 82, spd: 110, spe: 88 },
	...
	dragonite: {
		...
		evoLevel: 55,
		eggGroups: ["Water 1", "Dragon"],
		otherFormes: ["Dragonite-Azorian", "Dragonite-Mega"],
		formeOrder: ["Dragonite", "Dragonite-Azorian", "Dragonite-Mega"],
	},
	dragoniteazorian: {
		num: 149,
		name: "Dragonite-Azorian",
		baseSpecies: "Dragonite",
		forme: "Azorian",
		types: ["Dragon", "Psychic"],
		baseStats: { hp: 91, atk: 80, def: 75, spa: 134, spd: 90, spe: 130 },
		abilities: { 0: "Levitate", H: "Multiscale" },
		heightm: 2,
		weightkg: 150,
		color: "Blue",
		prevo: "Dragonair",
	...
	crobatmega: {
		...
		forme: "Mega",
		types: ["Poison", "Flying"],
		baseStats: { hp: 85, atk: 125, def: 90, spa: 70, spd: 90, spe: 175 },
	...
	hoppip: {
		...
		otherFormes: ["Hoppip-Azorian"],
		formeOrder: ["Hoppip", "Hoppip-Azorian"],
	},
	hoppipazorian: {
		num: 187,
		name: "Hoppip-Azorian",
		...
		forme: "Azorian",
		types: ["Grass", "Ground"],
		baseStats: { hp: 35, atk: 50, def: 40, spa: 30, spd: 45, spe: 50 },
		abilities: { 0: "Chlorophyll", 1: "Thorny Body", H: "Infiltrator" },
		heightm: 0.4,
		weightkg: 0.5,
		color: "Green",
		eggGroups: ["Fairy", "Grass"],
	...
	skiploom: {
		...
		evos: ["Jumpluff"],
		eggGroups: ["Fairy", "Grass"],
		otherFormes: ["Skiploom-Azorian"],
		formeOrder: ["Skiploom", "Skiploom-Azorian"],
	},
	skiploomazorian: {
		num: 188,
		name: "Skiploom-Azorian",
		baseSpecies: "Skiploom",
		forme: "Azorian",
		types: ["Grass", "Ground"],
		baseStats: { hp: 55, atk: 70, def: 45, spa: 40, spd: 50, spe: 80 },
		abilities: { 0: "Chlorophyll", 1: "Thorny Body", H: "Infiltrator" },
		heightm: 0.6,
		weightkg: 1,
		color: "Green",
	...
	jumpluff: {
		...
		evoLevel: 27,
		eggGroups: ["Fairy", "Grass"],
		otherFormes: ["Jumpluff-Azorian"],
		formeOrder: ["Jumpluff", "Jumpluff-Azorian"],
	},
	jumpluffazorian: {
		num: 189,
		name: "Jumpluff-Azorian",
		baseSpecies: "Jumpluff",
		forme: "Azorian",
		types: ["Grass", "Ground"],
		baseStats: { hp: 75, atk: 100, def: 60, spa: 50, spd: 65, spe: 110 },
		abilities: { 0: "Chlorophyll", 1: "Thorny Body", H: "Infiltrator" },
		heightm: 0.8,
		weightkg: 3,
		color: "Green",
		prevo: "Skiploom-Azori",
		evoLevel: 27,
		eggGroups: ["Fairy", "Grass"],
	},
	aipom: {
	...
	blissey: {
		...
		evoType: "levelFriendship",
		eggGroups: ["Fairy"],
		otherFormes: ["Blissey-Azorian"],
		formeOrder: ["Blissey", "Blissey-Azorian"],
	},
	blisseyazorian: {
		num: 242,
		name: "Blissey-Azorian",
		baseSpecies: "Blissey",
		forme: "Azorian",
		types: ["Fairy", "Poison"],
		gender: "F",
		baseStats: { hp: 225, atk: 10, def: 10, spa: 135, spd: 75, spe: 85 },
		abilities: { 0: "Natural Cure", 1: "Corrosion", H: "Merciless" },
		heightm: 1.4,
		weightkg: 42.8,
		color: "Purple",
		prevo: "Chansey",
	...
	torkoalmega: {
		...
		forme: "Mega",
		types: ["Fire"],
		baseStats: { hp: 70, atk: 90, def: 170, spa: 110, spd: 100, spe: 30 },
		abilities: { 0: "Drought" },
		heightm: 1.1,
		weightkg: 90.6,
		color: "Brown",
	...
	flygonmega: {
		...
		forme: "Mega",
		types: ["Dragon", "Bug"],
		baseStats: { hp: 80, atk: 135, def: 90, spa: 110, spd: 90, spe: 115 },
		abilities: { 0: "Multiscale" },
		heightm: 2.2,
		weightkg: 95.4,
		color: "Green",
	...
	roserademega: {
		...
		forme: "Mega",
		types: ["Grass", "Poison"],
		baseStats: { hp: 60, atk: 85, def: 90, spa: 145, spd: 125, spe: 110 },
		abilities: { 0: "Serene Grace" },
		heightm: 1.1,
		weightkg: 19.7,
		color: "Green",
	...
	krookodilemega: {
		...
		forme: "Mega",
		types: ["Ground", "Dark"],
		baseStats: { hp: 95, atk: 162, def: 95, spa: 70, spd: 95, spe: 102 },
	...
	crustlemega: {
		...
		forme: "Mega",
		types: ["Bug", "Rock"],
		baseStats: { hp: 70, atk: 125, def: 180, spa: 65, spd: 100, spe: 45 },
	...
	bouffalant: {
		...
		color: "Brown",
		eggGroups: ["Field"],
		otherFormes: ["Bouffalant-Azorian"],
		formeOrder: ["Bouffalant", "Bouffalant-Azorian"],
	},
	bouffalantazorian: {
		num: 626,
		name: "Bouffalant-Azorian",
		baseSpecies: "Bouffalant",
		forme: "Azorian",
		types: ["Normal", "Ghost"],
		baseStats: { hp: 95, atk: 75, def: 100, spa: 60, spd: 110, spe: 50 },
		abilities: { 0: "Reckless", 1: "Cursed Body", H: "Defiant" },
		heightm: 1.5,
		weightkg: 74.6,
		color: "Gray",
		eggGroups: ["Field"],
	...
	hydreigonmega: {
		...
		forme: "Mega",
		types: ["Dark", "Dragon"],
		baseStats: { hp: 92, atk: 125, def: 95, spa: 175, spd: 95, spe: 118 },
		abilities: { 0: "Berserk" },
		heightm: 2.1,
		weightkg: 182,
		color: "Blue",
	...
	aegislash: {
		...
		evoItem: "Dusk Stone",
		eggGroups: ["Mineral"],
		otherFormes: ["Aegislash-Blade", "Aegislash-Mega"],
		formeOrder: ["Aegislash", "Aegislash-Blade", "Aegislash-Mega"],
	},
	aegislashblade: {
		num: 681,
	...
	aegislashmega: {
		...
		forme: "Mega",
		types: ["Steel", "Ghost"],
		baseStats: { hp: 60, atk: 120, def: 120, spa: 120, spd: 120, spe: 60 },
		abilities: { 0: "Steely Spirit" },
		heightm: 1.8,
		weightkg: 61,
		color: "Brown",
		eggGroups: ["Mineral"],
		requiredItem: "Aegislashite",
	},
	spritzee: {
		num: 682,
		name: "Spritzee",
	...
	helioliskmega: {
		...
		forme: "Mega",
		types: ["Electric", "Dragon"],
		baseStats: { hp: 62, atk: 80, def: 52, spa: 124, spd: 104, spe: 159 },
		abilities: { 0: "Electric Surge" },
		heightm: 1.4,
		weightkg: 38.1,
		color: "Yellow",
	...
	dewpider: {
		...
		evos: ["Araquanid"],
		eggGroups: ["Water 1", "Bug"],
		otherFormes: ["Dewpider-Azorian"],
		formeOrder: ["Dewpider", "Dewpider-Azorian"],
	},
	dewpiderazorian: {
		num: -1751,
		name: "Dewpider-Azorian",
		baseSpecies: "Dewpider",
		forme: "Azorian",
		types: ["Ice", "Bug"],
		baseStats: { hp: 38, atk: 40, def: 40, spa: 27, spd: 52, spe: 72 },
		abilities: { 0: "Ice Body", H: "Refrigerate" },
		heightm: 0.3,
		weightkg: 4.4,
		color: "Green",
		evos: ["Araquanid-Azori"],
		eggGroups: ["Water 1", "Bug"],
	},
	araquanid: {
		num: 752,
		...
		evoLevel: 22,
		eggGroups: ["Water 1", "Bug"],
		otherFormes: ["Araquanid-Azorian"],
		formeOrder: ["Araquanid", "Araquanid-Azorian", "Araquanid-Totem"],
	},
	araquanidazorian: {
		num: 752,
		name: "Araquanid-Azorian",
		baseSpecies: "Araquanid",
		forme: "Azorian",
		types: ["Ice", "Bug"],
		baseStats: { hp: 65, atk: 70, def: 73, spa: 42, spd: 92, spe: 112 },
		abilities: { 0: "Ice Body", H: "Refrigerate" },
		heightm: 1.8,
		weightkg: 89,
		color: "Green",
		prevo: "Dewpider-Azori",
		evoLevel: 22,
		eggGroups: ["Water 1", "Bug"],
	},
	araquanidtotem: {
	...
	lagavo: {
		...
		types: ["Grass"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 65, atk: 55, def: 50, spa: 40, spd: 70, spe: 30 },
		abilities: { 0: "Overgrow", H: "Chlorophyll" },
		heightm: 0.4,
		weightkg: 5.4,
		color: "Green",
	...
	lagavien: {
		...
		types: ["Grass"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 90, atk: 82, def: 62, spa: 50, spd: 96, spe: 40 },
		abilities: { 0: "Overgrow", H: "Chlorophyll" },
		heightm: 0.9,
		weightkg: 47.8,
		color: "Green",
	...
	latremor: {
		...
		types: ["Grass", "Ground"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 107, atk: 105, def: 85, spa: 70, spd: 113, spe: 50 },
		abilities: { 0: "Overgrow", H: "Chlorophyll" },
		heightm: 1.6,
		weightkg: 167.8,
		color: "Green",
		...
		evoLevel: 36,
		eggGroups: ["Monster", "Grass"],
		otherFormes: ["Latremor-Mega"],
		formeOrder: ["Latremor", "Latremor-Mega"],
	},
	latremormega: {
		num: -1901,
		name: "Latremor-Mega",
		baseSpecies: "Latremor",
		forme: "Mega",
		types: ["Grass", "Steel"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 107, atk: 135, def: 110, spa: 75, spd: 143, spe: 60 },
		abilities: { 0: "Battle Armor" },
		heightm: 1.8,
		weightkg: 240.4,
		color: "Green",
		eggGroups: ["Monster", "Grass"],
		requiredItem: "Latremorite",
	},
	sparcyx: {
		num: -1902,
		name: "Sparcyx",
		types: ["Fire"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 40, atk: 58, def: 35, spa: 62, spd: 40, spe: 75 },
		abilities: { 0: "Blaze", H: "Flash Fire" },
		heightm: 0.5,
		weightkg: 4.6,
		color: "Red",
	...
	aurorun: {
		...
		types: ["Fire"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 55, atk: 76, def: 50, spa: 84, spd: 60, spe: 95 },
		abilities: { 0: "Blaze", H: "Flash Fire" },
		heightm: 0.9,
		weightkg: 13.2,
		color: "Red",
	...
	aurocyx: {
		...
		types: ["Fire", "Fairy"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 70, atk: 90, def: 60, spa: 110, spd: 75, spe: 125 },
		abilities: { 0: "Blaze", H: "Flash Fire" },
		heightm: 1.6,
		weightkg: 43.3,
		color: "Red",
		...
		evoLevel: 37,
		eggGroups: ["Fairy", "Field"],
		otherFormes: ["Aurocyx-Mega"],
		formeOrder: ["Aurocyx", "Aurocyx-Mega"],
	},
	aurocyxmega: {
		num: -1904,
		name: "Aurocyx-Mega",
		...
		types: ["Fire", "Fairy"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 70, atk: 110, def: 80, spa: 125, spd: 95, spe: 150 },
		abilities: { 0: "Flame Body" },
		heightm: 1.8,
		weightkg: 58.3,
		color: "Red",
		eggGroups: ["Fairy", "Field"],
		requiredItem: "Aurocite",
	},
	platyke: {
		num: -1905,
		name: "Platyke",
		types: ["Water"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 54, atk: 66, def: 50, spa: 44, spd: 44, spe: 52 },
	...
	platyspar: {
		...
		types: ["Water"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 74, atk: 90, def: 66, spa: 60, spd: 60, spe: 70 },
		abilities: { 0: "Torrent", H: "Swift Swim" },
		heightm: 1.1,
		weightkg: 31.8,
		color: "Blue",
	...
	platypunch: {
		...
		types: ["Water", "Fighting"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 100, atk: 115, def: 82, spa: 74, spd: 74, spe: 85 },
		abilities: { 0: "Torrent", H: "Swift Swim" },
		heightm: 1.9,
		weightkg: 98,
		color: "Blue",
		...
		evoLevel: 34,
		eggGroups: ["Monster", "Water 1"],
		otherFormes: ["Platypunch-Mega"],
		formeOrder: ["Platypunch", "Platypunch-Mega"],
	},
	platypunchmega: {
		num: -1907,
		name: "Platypunch-Mega",
		baseSpecies: "Platypunch",
		forme: "Mega",
		types: ["Water", "Poison"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 100, atk: 155, def: 102, spa: 84, spd: 84, spe: 105 },
		abilities: { 0: "Poison Touch" },
		heightm: 2.1,
		weightkg: 127,
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
		requiredItem: "Platypunchite",
	},
	wrini: {
		num: -1908,
		name: "Wrini",
		types: ["Flying"],
		baseStats: { hp: 45, atk: 50, def: 30, spa: 50, spd: 35, spe: 60 },
		abilities: { 0: "Big Pecks", H: "Infiltrator" },
		heightm: 0.3,
		weightkg: 2.2,
		color: "Gray",
		evos: ["Wrengal"],
	...
	wrengal: {
		...
		name: "Wrengal",
		types: ["Flying"],
		baseStats: { hp: 63, atk: 68, def: 50, spa: 68, spd: 55, spe: 76 },
		abilities: { 0: "Big Pecks", H: "Infiltrator" },
		heightm: 0.8,
		weightkg: 9.6,
		color: "Gray",
	...
	wrengade: {
		...
		types: ["Dark", "Flying"],
		gender: "M",
		baseStats: { hp: 83, atk: 90, def: 70, spa: 72, spd: 70, spe: 105 },
	...
	wrenquiem: {
		...
		types: ["Ghost", "Flying"],
		gender: "F",
		baseStats: { hp: 83, atk: 72, def: 70, spa: 90, spd: 82, spe: 93 },
		abilities: { 0: "Serene Grace", H: "Infiltrator" },
		heightm: 1.4,
		weightkg: 37,
		color: "Gray",
		prevo: "Wrengal",
		evoLevel: 37,
		evoCondition: "if female",
		eggGroups: ["Flying"],
	},
	burrot: {
		num: -1912,
		name: "Burrot",
		types: ["Normal"],
		baseStats: { hp: 65, atk: 55, def: 45, spa: 20, spd: 30, spe: 40 },
		abilities: { 0: "Keen Eye", H: "Technician" },
		heightm: 0.4,
		weightkg: 5.9,
		color: "Brown",
		evos: ["Burthrow"],
	...
	burthrow: {
		...
		name: "Burthrow",
		types: ["Normal", "Rock"],
		baseStats: { hp: 104, atk: 86, def: 75, spa: 45, spd: 65, spe: 70 },
		abilities: { 0: "Keen Eye", H: "Technician" },
		heightm: 0.6,
		weightkg: 95.3,
		color: "Brown",
	...
	larfluff: {
		...
		name: "Larfluff",
		types: ["Bug"],
		baseStats: { hp: 30, atk: 50, def: 45, spa: 20, spd: 35, spe: 35 },
		abilities: { 0: "Run Away", H: "Unaware" },
		heightm: 0.1,
		weightkg: 1.9,
		color: "Green",
		evos: ["Cocoonix"],
	...
	cocoonix: {
		...
		name: "Cocoonix",
		types: ["Bug"],
		baseStats: { hp: 55, atk: 30, def: 55, spa: 45, spd: 40, spe: 20 },
		abilities: { 0: "Shed Skin", H: "Unaware" },
		heightm: 0.4,
		weightkg: 4.5,
		color: "Green",
		prevo: "Larfluff",
	...
	luminoth: {
		...
		name: "Luminoth",
		types: ["Bug", "Flying"],
		baseStats: { hp: 85, atk: 50, def: 75, spa: 85, spd: 80, spe: 75 },
	...
	bikkunise: {
		...
		name: "Bikkunise",
		types: ["Electric", "Grass"],
		baseStats: { hp: 65, atk: 50, def: 87, spa: 92, spd: 60, spe: 78 },
		abilities: { 0: "Grass Pelt", 1: "Static", H: "Motor Drive" },
		heightm: 0.4,
		weightkg: 5.6,
		color: "Green",
		eggGroups: ["Field", "Grass"],
	...
	snuffluff: {
		...
		name: "Snuffluff",
		types: ["Normal"],
		baseStats: { hp: 100, atk: 80, def: 85, spa: 50, spd: 90, spe: 60 },
		abilities: { 0: "Friend Guard" },
		heightm: 1.1,
		weightkg: 52.5,
		color: "Gray",
		eggGroups: ["Field"],
		otherFormes: ["Snuffluff-Mega"],
		formeOrder: ["Snuffluff", "Snuffluff-Mega"],
	},
	snuffluffmega: {
		num: -1918,
		name: "Snuffluff-Mega",
		baseSpecies: "Snuffluff",
		forme: "Mega",
		types: ["Normal"],
		baseStats: { hp: 100, atk: 90, def: 125, spa: 60, spd: 125, spe: 65 },
		abilities: { 0: "Thick Fat" },
		heightm: 1.8,
		weightkg: 145.15,
		color: "Gray",
		eggGroups: ["Field"],
		requiredItem: "Snuffluffite",
	},
	kamakid: {
		num: -1919,
		name: "Kamakid",
		types: ["Bug"],
		baseStats: { hp: 38, atk: 55, def: 32, spa: 29, spd: 28, spe: 58 },
	...
	kamasei: {
		...
		name: "Kamasei",
		types: ["Bug", "Fighting"],
		baseStats: { hp: 76, atk: 105, def: 70, spa: 75, spd: 63, spe: 96 },
		abilities: { 0: "Limber", H: "Inner Focus" },
		heightm: 1.4,
		weightkg: 34.2,
		color: "Green",
	...
	stellopod: {
		...
		name: "Stellopod",
		types: ["Water"],
		baseStats: { hp: 40, atk: 34, def: 48, spa: 65, spd: 48, spe: 40 },
		abilities: { 0: "Damp", 1: "Suction Cups", H: "Regenerator" },
		heightm: 0.5,
		weightkg: 4.7,
		color: "Blue",
		evos: ["Cephastar"],
	...
	cephastar: {
		...
		name: "Cephastar",
		types: ["Water"],
		baseStats: { hp: 63, atk: 45, def: 70, spa: 80, spd: 70, spe: 62 },
		abilities: { 0: "Damp", 1: "Suction Cups", H: "Regenerator" },
		heightm: 0.8,
		weightkg: 19.5,
		color: "Blue",
	...
	celumina: {
		...
		name: "Celumina",
		types: ["Water"],
		baseStats: { hp: 89, atk: 64, def: 88, spa: 102, spd: 88, spe: 74 },
		abilities: { 0: "Damp", 1: "Suction Cups", H: "Regenerator" },
		heightm: 1.7,
		weightkg: 60.4,
		color: "Blue",
	...
	whimsijack: {
		...
		name: "Whimsijack",
		types: ["Normal", "Fairy"],
		baseStats: { hp: 83, atk: 59, def: 64, spa: 88, spd: 82, spe: 97 },
		abilities: { 0: "Super Luck", H: "Technician" },
		heightm: 0.4,
		weightkg: 8.5,
		color: "Brown",
		eggGroups: ["Fairy", "Field"],
	...
	tanukiroot: {
		...
		name: "Tanukiroot",
		types: ["Grass", "Psychic"],
		baseStats: { hp: 40, atk: 40, def: 45, spa: 75, spd: 50, spe: 70 },
		abilities: { 0: "Magician", 1: "Prankster", H: "Psychic Surge" },
		heightm: 0.5,
		weightkg: 9.2,
		color: "Green",
		evos: ["Branuki"],
	...
	branuki: {
		...
		name: "Branuki",
		types: ["Grass", "Psychic"],
		baseStats: { hp: 60, atk: 45, def: 60, spa: 95, spd: 65, spe: 85 },
		abilities: { 0: "Magician", 1: "Prankster", H: "Psychic Surge" },
		heightm: 0.9,
		weightkg: 26.5,
		color: "Green",
	...
	treenuki: {
		...
		name: "Treenuki",
		types: ["Grass", "Psychic"],
		baseStats: { hp: 70, atk: 62, def: 70, spa: 112, spd: 81, spe: 105 },
		abilities: { 0: "Magician", 1: "Prankster", H: "Psychic Surge" },
		heightm: 1.6,
		weightkg: 70.7,
		color: "Green",
	...
	rolil: {
		...
		types: ["Bug"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 45, atk: 50, def: 70, spa: 40, spd: 70, spe: 55 },
		abilities: { 0: "Swarm", 1: "Reckless", H: "Guts" },
		heightm: 0.2,
		weightkg: 9.8,
		color: "Gray",
		evos: ["Rolidozer"],
	...
	rolidozer: {
		...
		types: ["Bug", "Steel"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 75, atk: 75, def: 100, spa: 55, spd: 100, spe: 90 },
		abilities: { 0: "Swarm", 1: "Reckless", H: "Guts" },
		heightm: 1.2,
		weightkg: 188.2,
		color: "Gray",
	...
	volten: {
		...
		types: ["Electric", "Dark"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 38, atk: 60, def: 32, spa: 48, spd: 32, spe: 60 },
		abilities: { 0: "Full Charge", 1: "Tough Claws", H: "Volt Absorb" },
		heightm: 0.3,
		weightkg: 4.4,
		color: "Black",
		evos: ["Panthere"],
	...
	panthere: {
		...
		types: ["Electric", "Dark"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 54, atk: 75, def: 50, spa: 66, spd: 50, spe: 75 },
		abilities: { 0: "Full Charge", 1: "Tough Claws", H: "Volt Absorb" },
		heightm: 0.5,
		weightkg: 11.4,
		color: "Black",
	...
	phantohm: {
		...
		types: ["Electric", "Dark"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 78, atk: 110, def: 67, spa: 83, spd: 67, spe: 105 },
		abilities: { 0: "Full Charge", 1: "Tough Claws", H: "Volt Absorb" },
		heightm: 1.4,
		weightkg: 79.7,
		color: "Black",
		...
		evoLevel: 34,
		eggGroups: ["Field"],
		otherFormes: ["Phantohm-Mega"],
		formeOrder: ["Phantohm", "Phantohm-Mega"],
	},
	phantohmmega: {
		num: -1932,
		name: "Phantohm-Mega",
		baseSpecies: "Phantohm",
		forme: "Mega",
		types: ["Electric", "Dark"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 78, atk: 130, def: 77, spa: 103, spd: 77, spe: 145 },
		abilities: { 0: "Inner Focus" },
		heightm: 1.6,
		weightkg: 95.3,
		color: "Black",
		eggGroups: ["Field"],
		requiredItem: "Phantohmite",
	},
	parapossum: {
		num: -1933,
		name: "Parapossum",
		types: ["Flying"],
		baseStats: { hp: 64, atk: 76, def: 58, spa: 76, spd: 58, spe: 100 },
		abilities: { 0: "Limber", H: "Infiltrator" },
		heightm: 0.4,
		weightkg: 5,
		color: "White",
		eggGroups: ["Field"],
	...
	charcupine: {
		...
		types: ["Fire"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 75, atk: 60, def: 46, spa: 56, spd: 46, spe: 40 },
		abilities: { 0: "Skill Link", H: "Flash Fire" },
		heightm: 0.5,
		weightkg: 6.1,
		color: "Brown",
		evos: ["Scorcupine"],
	...
	scorcupine: {
		...
		types: ["Fire"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 102, atk: 90, def: 72, spa: 80, spd: 72, spe: 64 },
		abilities: { 0: "Skill Link", H: "Flash Fire" },
		heightm: 1,
		weightkg: 29.9,
		color: "Brown",
	...
	rattleghast: {
		...
		types: ["Poison", "Ghost"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 50, atk: 68, def: 36, spa: 50, spd: 63, spe: 58 },
		abilities: { 0: "Shed Skin", 1: "Merciless", H: "Rattled" },
		heightm: 0.8,
		weightkg: 2.7,
		color: "Purple",
		evos: ["Spectrattle"],
	...
	spectrattle: {
		...
		types: ["Poison", "Ghost"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 70, atk: 105, def: 66, spa: 80, spd: 92, spe: 85 },
		abilities: { 0: "Shed Skin", 1: "Merciless", H: "Rattled" },
		heightm: 1.2,
		weightkg: 9.25,
		color: "Purple",
	...
	jabberoo: {
		...
		types: ["Fighting"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 61, atk: 70, def: 55, spa: 33, spd: 35, spe: 49 },
		abilities: { 0: "Limber", 1: "Iron Fist", H: "Scrappy" },
		heightm: 0.4,
		weightkg: 6.4,
		color: "Brown",
		evos: ["Clobberoo"],
	...
	clobberoo: {
		...
		types: ["Fighting"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 76, atk: 97, def: 72, spa: 46, spd: 49, spe: 65 },
		abilities: { 0: "Limber", 1: "Iron Fist", H: "Scrappy" },
		heightm: 0.7,
		weightkg: 21.8,
		color: "Brown",
	...
	rootality: {
		...
		types: ["Fighting", "Dark"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: { hp: 95, atk: 118, def: 90, spa: 52, spd: 68, spe: 80 },
		abilities: { 0: "Limber", 1: "Iron Fist", H: "Scrappy" },
		heightm: 1.8,
		weightkg: 101.2,
		color: "Brown",
	...
	marling: {
		...
		types: ["Water", "Steel"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 55, atk: 75, def: 60, spa: 45, spd: 40, spe: 50 },
		abilities: { 0: "Swift Swim", 1: "Moxie", H: "Sharpness" },
		heightm: 0.6,
		weightkg: 24.5,
		color: "Blue",
		evos: ["Martana"],
	...
	martana: {
		...
		types: ["Water", "Steel"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 70, atk: 116, def: 90, spa: 68, spd: 61, spe: 75 },
		abilities: { 0: "Swift Swim", 1: "Moxie", H: "Sharpness" },
		heightm: 1.3,
		weightkg: 108.9,
		color: "Black",
	...
	parkel: {
		...
		name: "Parkel",
		types: ["Ice"],
		baseStats: { hp: 55, atk: 35, def: 50, spa: 58, spd: 70, spe: 52 },
		abilities: { 0: "Snow Cloak", H: "Fur Coat" },
		heightm: 0.4,
		weightkg: 6.8,
		color: "Blue",
		evos: ["Parktic"],
	...
	parktic: {
		...
		name: "Parktic",
		types: ["Ice"],
		baseStats: { hp: 80, atk: 55, def: 59, spa: 85, spd: 110, spe: 86 },
		abilities: { 0: "Snow Cloak", H: "Fur Coat" },
		heightm: 1.1,
		weightkg: 24.7,
		color: "Blue",
	...
	cluddle: {
		...
		types: ["Rock"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 50, atk: 45, def: 70, spa: 30, spd: 65, spe: 20 },
		abilities: { 0: "Sturdy", 1: "Heatproof", H: "Water Compaction" },
		heightm: 0.3,
		weightkg: 6,
		color: "Brown",
		evos: ["Adolem"],
	...
	adolem: {
		...
		types: ["Rock"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 70, atk: 65, def: 95, spa: 35, spd: 85, spe: 40 },
		abilities: { 0: "Sturdy", 1: "Heatproof", H: "Water Compaction" },
		heightm: 0.9,
		weightkg: 28.1,
		color: "Brown",
	...
	adobalith: {
		...
		types: ["Rock"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 105, atk: 95, def: 125, spa: 50, spd: 90, spe: 50 },
		abilities: { 0: "Sturdy", 1: "Heatproof", H: "Water Compaction" },
		heightm: 1.8,
		weightkg: 240.4,
		color: "Brown",
	...
	stalcria: {
		...
		name: "Stalcria",
		types: ["Steel", "Normal"],
		baseStats: { hp: 50, atk: 45, def: 84, spa: 32, spd: 74, spe: 35 },
		abilities: { 0: "Steel Wool", H: "Overcoat" },
		heightm: 0.8,
		weightkg: 50.8,
		color: "Gray",
		evos: ["Stalpaca"],
	...
	stalpaca: {
		...
		name: "Stalpaca",
		types: ["Steel", "Normal"],
		baseStats: { hp: 95, atk: 74, def: 118, spa: 50, spd: 108, spe: 55 },
		abilities: { 0: "Steel Wool", H: "Overcoat" },
		heightm: 1.7,
		weightkg: 132.6,
		color: "Gray",
	...
	embush: {
		...
		types: ["Grass", "Fire"],
		gender: "N",
		baseStats: { hp: 95, atk: 37, def: 47, spa: 74, spd: 50, spe: 57 },
		abilities: { 0: "Flame Body", 1: "Unnerve", H: "Flash Fire" },
		heightm: 0.5,
		weightkg: 10.7,
		color: "Brown",
		evos: ["Horeburn"],
	...
	horeburn: {
		...
		types: ["Grass", "Fire"],
		gender: "N",
		baseStats: { hp: 120, atk: 63, def: 73, spa: 101, spd: 90, spe: 83 },
		abilities: { 0: "Flame Body", 1: "Unnerve", H: "Flash Fire" },
		heightm: 0.8,
		weightkg: 28.9,
		color: "Brown",
	...
	eimole: {
		...
		types: ["Ground", "Fighting"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 53, atk: 71, def: 60, spa: 33, spd: 33, spe: 45 },
		abilities: { 0: "Oblivious", H: "No Guard" },
		heightm: 0.3,
		weightkg: 11.4,
		color: "Brown",
		evos: ["Treimor"],
	...
	treimor: {
		...
		types: ["Ground", "Fighting"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 60, atk: 83, def: 70, spa: 41, spd: 41, spe: 50 },
		abilities: { 0: "Oblivious", H: "No Guard" },
		heightm: 0.9,
		weightkg: 20.1,
		color: "Brown",
	...
	cheimgar: {
		...
		types: ["Ground", "Fighting"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 80, atk: 116, def: 97, spa: 61, spd: 61, spe: 75 },
		abilities: { 0: "Oblivious", H: "No Guard" },
		heightm: 1.6,
		weightkg: 64.5,
		color: "Brown",
	...
	alacruico: {
		...
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 106, atk: 58, def: 65, spa: 116, spd: 85, spe: 70 },
		abilities: { 0: "Long Reach", H: "Poison Point" },
		heightm: 1.3,
		weightkg: 29.4,
		color: "Purple",
	...
	diablare: {
		...
		name: "Diablare",
		types: ["Fire", "Dark"],
		baseStats: { hp: 62, atk: 78, def: 68, spa: 50, spd: 43, spe: 65 },
	...
	diablaze: {
		...
		name: "Diablaze",
		types: ["Fire", "Dark"],
		baseStats: { hp: 82, atk: 116, def: 88, spa: 70, spd: 68, spe: 76 },
		abilities: { 0: "Anger Point", H: "Sheer Force" },
		heightm: 1.6,
		weightkg: 67.8,
		color: "Black",
	...
	cypup: {
		...
		name: "Cypup",
		types: ["Grass"],
		baseStats: { hp: 40, atk: 65, def: 35, spa: 65, spd: 35, spe: 70 },
		abilities: { 0: "Friend Guard", 1: "Stakeout", H: "Grassy Surge" },
		heightm: 0.4,
		weightkg: 10.4,
		color: "Green",
		evos: ["Cyprowl"],
	...
	cyprowl: {
		...
		name: "Cyprowl",
		types: ["Grass"],
		baseStats: { hp: 74, atk: 95, def: 53, spa: 90, spd: 53, spe: 115 },
		abilities: { 0: "Friend Guard", 1: "Stakeout", H: "Grassy Surge" },
		heightm: 1.2,
		weightkg: 44,
		color: "Green",
	...
	apozip: {
		...
		name: "Apozip",
		types: ["Electric", "Flying"],
		baseStats: { hp: 40, atk: 55, def: 32, spa: 59, spd: 33, spe: 91 },
		abilities: { 0: "Speed Boost", H: "Early Bird" },
		heightm: 0.2,
		weightkg: 1.7,
		color: "Yellow",
		evos: ["Apozoom"],
	...
	apozoom: {
		...
		name: "Apozoom",
		types: ["Electric", "Flying"],
		baseStats: { hp: 71, atk: 85, def: 53, spa: 95, spd: 54, spe: 125 },
		abilities: { 0: "Speed Boost", H: "Early Bird" },
		heightm: 1.5,
		weightkg: 14.5,
		color: "Yellow",
	...
	salaphyt: {
		...
		types: ["Water", "Grass"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 42, atk: 30, def: 30, spa: 73, spd: 63, spe: 42 },
	...
	phyloch: {
		...
		types: ["Water", "Grass"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 73, atk: 50, def: 50, spa: 102, spd: 82, spe: 73 },
		abilities: { 0: "Swift Swim", H: "Storm Drain" },
		heightm: 0.9,
		weightkg: 20.4,
		color: "Blue",
	...
	torreloch: {
		...
		types: ["Water", "Dragon"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 92, atk: 60, def: 60, spa: 135, spd: 101, spe: 92 },
		abilities: { 0: "Swift Swim", H: "Storm Drain" },
		heightm: 1.9,
		weightkg: 167.8,
		color: "Blue",
	...
	dustcoon: {
		...
		name: "Dustcoon",
		types: ["Ground", "Poison"],
		baseStats: { hp: 36, atk: 54, def: 58, spa: 63, spd: 58, spe: 36 },
		abilities: { 0: "Shield Dust", 1: "Pickup", H: "Pickpocket" },
		heightm: 0.4,
		weightkg: 11.3,
		color: "Brown",
		evos: ["Toxcoon"],
	...
	toxcoon: {
		...
		name: "Toxcoon",
		types: ["Ground", "Poison"],
		baseStats: { hp: 56, atk: 82, def: 89, spa: 103, spd: 89, spe: 56 },
		abilities: { 0: "Shield Dust", 1: "Pickup", H: "Pickpocket" },
		heightm: 1.4,
		weightkg: 49.9,
		color: "Brown",
	...
	stegodite: {
		...
		types: ["Rock", "Steel"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 88, atk: 49, def: 65, spa: 59, spd: 65, spe: 36 },
		abilities: { 0: "Solid Rock", H: "Steadfast" },
		heightm: 1.2,
		weightkg: 120.2,
		color: "Gray",
		evos: ["Stegeodon"],
	...
	stegeodon: {
		...
		types: ["Rock", "Steel"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 129, atk: 72, def: 91, spa: 82, spd: 91, spe: 56 },
		abilities: { 0: "Solid Rock", H: "Steadfast" },
		heightm: 2.4,
		weightkg: 287.6,
		color: "Gray",
	...
	obsidodile: {
		...
		types: ["Rock", "Dark"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 70, atk: 92, def: 62, spa: 34, spd: 50, spe: 54 },
		abilities: { 0: "Strong Jaw", H: "Intimidate" },
		heightm: 0.8,
		weightkg: 38.8,
		color: "Brown",
		evos: ["Obsidoruth"],
	...
	obsidoruth: {
		...
		types: ["Rock", "Dark"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 96, atk: 142, def: 88, spa: 50, spd: 71, spe: 74 },
		abilities: { 0: "Strong Jaw", H: "Intimidate" },
		heightm: 1.4,
		weightkg: 127.4,
		color: "Brown",
	...
	brawnsoon: {
		...
		baseForme: "Drought",
		types: ["Water"],
		baseStats: { hp: 72, atk: 58, def: 55, spa: 65, spd: 55, spe: 105 },
		abilities: { 0: "Storm Surge" },
		heightm: 0.4,
		weightkg: 0.4,
		color: "Blue",
		eggGroups: ["Water 2", "Amorphous"],
		otherFormes: ["Brawnsoon-Flood"],
		formeOrder: ["Brawnsoon", "Brawnsoon-Flood"],
	},
	brawnsoonflood: {
		num: -1971,
		name: "Brawnsoon-Flood",
		baseSpecies: "Brawnsoon",
		forme: "Flood",
		types: ["Water"],
		baseStats: { hp: 108, atk: 148, def: 97, spa: 75, spd: 97, spe: 85 },
		abilities: { 0: "Storm Surge" },
		heightm: 1.9,
		weightkg: 190,
		color: "Blue",
	...
	polterick: {
		...
		types: ["Ghost"],
		gender: "N",
		baseStats: { hp: 58, atk: 42, def: 50, spa: 55, spd: 70, spe: 35 },
		abilities: { 0: "Cursed Body", H: "Contrary" },
		heightm: 0.3,
		weightkg: 5,
		color: "Purple",
		evos: ["Deceptjinn"],
	...
	deceptjinn: {
		...
		types: ["Ghost"],
		gender: "N",
		baseStats: { hp: 103, atk: 59, def: 70, spa: 87, spd: 121, spe: 50 },
		abilities: { 0: "Cursed Body", H: "Contrary" },
		heightm: 1.8,
		weightkg: 27.3,
		color: "Purple",
	...
	bullectric: {
		...
		name: "Bullectric",
		types: ["Electric"],
		baseStats: { hp: 60, atk: 62, def: 45, spa: 30, spd: 38, spe: 47 },
		abilities: { 0: "Magnet Pull", H: "Lightning Rod" },
		heightm: 0.9,
		weightkg: 34.2,
		color: "Gray",
		evos: ["Capacitaur"],
	...
	capacitaur: {
		...
		name: "Capacitaur",
		types: ["Electric"],
		baseStats: { hp: 80, atk: 86, def: 71, spa: 38, spd: 45, spe: 62 },
		abilities: { 0: "Magnet Pull", H: "Lightning Rod" },
		heightm: 1.3,
		weightkg: 63.5,
		color: "Gray",
	...
	magnetaur: {
		...
		name: "Magnetaur",
		types: ["Electric", "Fighting"],
		baseStats: { hp: 100, atk: 122, def: 93, spa: 46, spd: 64, spe: 87 },
		abilities: { 0: "Magnet Pull", H: "Lightning Rod" },
		heightm: 3.7,
		weightkg: 215.9,
		color: "Gray",
		...
		evoLevel: 44,
		eggGroups: ["Field", "Monster"],
		otherFormes: ["Magnetaur-Mega"],
		formeOrder: ["Magnetaur", "Magnetaur-Mega"],
	},
	magnetaurmega: {
		num: -1976,
		name: "Magnetaur-Mega",
		baseSpecies: "Magnetaur",
		forme: "Mega",
		types: ["Electric", "Fighting"],
		baseStats: { hp: 100, atk: 142, def: 133, spa: 51, spd: 79, spe: 107 },
		abilities: { 0: "Anger Point" },
		heightm: 3.7,
		weightkg: 438.5,
		color: "Gray",
		eggGroups: ["Field", "Monster"],
		requiredItem: "Magnetaurite",
	},
	fridglet: {
		num: -1977,
		name: "Fridglet",
		types: ["Ice", "Flying"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 62, atk: 44, def: 50, spa: 70, spd: 50, spe: 54 },
		abilities: { 0: "Keen Eye", 1: "Snow Cloak", H: "Inner Focus" },
		heightm: 0.4,
		weightkg: 7.3,
		color: "White",
		evos: ["Frigidae"],
	...
	frigidae: {
		...
		types: ["Ice", "Flying"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 91, atk: 62, def: 72, spa: 103, spd: 72, spe: 85 },
		abilities: { 0: "Keen Eye", 1: "Snow Cloak", H: "Inner Focus" },
		heightm: 1.2,
		weightkg: 42.3,
		color: "White",
		...
		evoLevel: 32,
		eggGroups: ["Flying"],
		otherFormes: ["Frigidae-Mega"],
		formeOrder: ["Frigidae", "Frigidae-Mega"],
	},
	frigidaemega: {
		num: -1978,
		name: "Frigidae-Mega",
		baseSpecies: "Frigidae",
		forme: "Mega",
		types: ["Ice", "Ghost"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 91, atk: 62, def: 102, spa: 133, spd: 102, spe: 95 },
		abilities: { 0: "Spectralize" },
		heightm: 1.4,
		weightkg: 58.9,
		color: "White",
		eggGroups: ["Flying"],
		requiredItem: "Frigidite",
	},
	chupacarno: {
		num: -1979,
		name: "Chupacarno",
		types: ["Ghost", "Dark"],
		baseStats: { hp: 76, atk: 116, def: 64, spa: 75, spd: 64, spe: 100 },
		abilities: { 0: "Intimidate", 1: "Limber", H: "Cursed Body" },
		heightm: 0.9,
		weightkg: 42.3,
		color: "Brown",
		eggGroups: ["Monster"],
	...
	spritanium: {
		...
		types: ["Fairy", "Steel"],
		gender: "F",
		baseStats: { hp: 49, atk: 49, def: 36, spa: 55, spd: 70, spe: 56 },
		abilities: { 0: "Magic Guard", 1: "Clear Body", H: "Adaptability" },
		heightm: 0.2,
		weightkg: 3.5,
		color: "Green",
		evos: ["Titanimaam"],
	...
	titanimaam: {
		...
		types: ["Fairy", "Steel"],
		gender: "F",
		baseStats: { hp: 74, atk: 76, def: 56, spa: 89, spd: 100, spe: 90 },
		abilities: { 0: "Magic Guard", 1: "Clear Body", H: "Adaptability" },
		heightm: 0.6,
		weightkg: 14.8,
		color: "Green",
		...
		evoLevel: 30,
		eggGroups: ["Fairy", "Humanlike"],
		otherFormes: ["Titanimaam-Mega"],
		formeOrder: ["Titanimaam", "Titanimaam-Mega"],
	},
	titanimaammega: {
		num: -1981,
		name: "Titanimaam-Mega",
		baseSpecies: "Titanimaam",
		forme: "Mega",
		types: ["Fairy", "Steel"],
		gender: "F",
		baseStats: { hp: 74, atk: 83, def: 71, spa: 112, spd: 130, spe: 115 },
		abilities: { 0: "Competitive" },
		heightm: 1.1,
		weightkg: 38.6,
		color: "Green",
		eggGroups: ["Fairy", "Humanlike"],
		requiredItem: "Titanimaamite",
	},
	chember: {
		num: -1982,
		name: "Chember",
		types: ["Fire", "Flying"],
		baseStats: { hp: 45, atk: 35, def: 44, spa: 65, spd: 54, spe: 52 },
		abilities: { 0: "Eternal Flame", H: "Flame Body" },
		heightm: 0.4,
		weightkg: 4.1,
		color: "Red",
		evos: ["Flaenix"],
	...
	flaenix: {
		...
		name: "Flaenix",
		types: ["Fire", "Psychic"],
		baseStats: { hp: 68, atk: 52, def: 66, spa: 92, spd: 86, spe: 71 },
		abilities: { 0: "Eternal Flame", H: "Flame Body" },
		heightm: 0.8,
		weightkg: 21.3,
		color: "Red",
	...
	infernoix: {
		...
		name: "Infernoix",
		types: ["Fire", "Psychic"],
		baseStats: { hp: 86, atk: 68, def: 74, spa: 114, spd: 108, spe: 90 },
		abilities: { 0: "Eternal Flame", H: "Flame Body" },
		heightm: 1.6,
		weightkg: 45.8,
		color: "Red",
		...
		evoLevel: 48,
		eggGroups: ["Flying"],
		otherFormes: ["Infernoix-Mega"],
		formeOrder: ["Infernoix", "Infernoix-Mega"],
	},
	infernoixmega: {
		num: -1984,
		name: "Infernoix-Mega",
		baseSpecies: "Infernoix",
		forme: "Mega",
		types: ["Fire", "Psychic"],
		baseStats: { hp: 86, atk: 73, def: 94, spa: 149, spd: 128, spe: 110 },
		abilities: { 0: "Regenerator" },
		heightm: 1.8,
		weightkg: 63.5,
		color: "Red",
		eggGroups: ["Flying"],
		requiredItem: "Infernoixite",
	},
	toxila: {
		num: -1985,
		name: "Toxila",
		types: ["Dragon", "Poison"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 82, atk: 65, def: 51, spa: 60, spd: 46, spe: 36 },
		abilities: { 0: "Poison Point", H: "Guts" },
		heightm: 0.6,
		weightkg: 20.4,
		color: "Purple",
		evos: ["Gilagon"],
	...
	gilagon: {
		...
		types: ["Dragon", "Poison"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 107, atk: 85, def: 76, spa: 80, spd: 71, spe: 61 },
		abilities: { 0: "Poison Point", H: "Guts" },
		heightm: 1.8,
		weightkg: 137.5,
		color: "Purple",
	...
	oracub: {
		...
		types: ["Normal", "Psychic"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 44, atk: 40, def: 52, spa: 65, spd: 67, spe: 42 },
		abilities: { 0: "Magic Guard", 1: "Forewarn", H: "Telepathy" },
		heightm: 0.7,
		weightkg: 24.3,
		color: "Gray",
		evos: ["Roaracle"],
	...
	roaracle: {
		...
		types: ["Normal", "Psychic"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 78, atk: 60, def: 102, spa: 95, spd: 117, spe: 68 },
		abilities: { 0: "Magic Guard", 1: "Forewarn", H: "Telepathy" },
		heightm: 1.9,
		weightkg: 148.2,
		color: "Gray",
		...
		evoLevel: 36,
		eggGroups: ["Field"],
		otherFormes: ["Roaracle-Mega"],
		formeOrder: ["Roaracle", "Roaracle-Mega"],
	},
	roaraclemega: {
		num: -1988,
		name: "Roaracle-Mega",
		baseSpecies: "Roaracle",
		forme: "Mega",
		types: ["Normal", "Psychic"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 78, atk: 65, def: 122, spa: 130, spd: 147, spe: 78 },
		abilities: { 0: "Analytic" },
		heightm: 2.1,
		weightkg: 186,
		color: "Gray",
		eggGroups: ["Field"],
		requiredItem: "Roaraclite",
	},
	outlage: {
		num: -1989,
		name: "Outlage",
		types: ["Ghost", "Ground"],
		gender: "N",
		baseStats: { hp: 78, atk: 65, def: 62, spa: 117, spd: 85, spe: 98 },
		abilities: { 0: "Sand Stream", H: "Wandering Spirit" },
		heightm: 1.8,
		weightkg: 33.1,
		color: "Brown",
		eggGroups: ["Amorphous"],
	...
	sileam: {
		...
		types: ["Water", "Fairy"],
		gender: "F",
		baseStats: { hp: 35, atk: 20, def: 55, spa: 45, spd: 55, spe: 30 },
		abilities: { 0: "Water Veil", 1: "Cute Charm", H: "Natural Cure" },
		heightm: 0.4,
		weightkg: 10.4,
		color: "Blue",
		evos: ["Naiadance"],
		eggGroups: ["Water 2", "Humanlike"],
	},
	naiadance: {
		num: -1991,
		name: "Naiadance",
		types: ["Water", "Fairy"],
		gender: "F",
		baseStats: { hp: 55, atk: 40, def: 83, spa: 64, spd: 88, spe: 50 },
		abilities: { 0: "Water Veil", 1: "Cute Charm", H: "Natural Cure" },
		heightm: 0.9,
		weightkg: 39,
		color: "Blue",
	...
	naiphoria: {
		...
		types: ["Water", "Fairy"],
		gender: "F",
		baseStats: { hp: 80, atk: 45, def: 102, spa: 92, spd: 121, spe: 70 },
		abilities: { 0: "Water Veil", 1: "Cute Charm", H: "Natural Cure" },
		heightm: 1.7,
		weightkg: 61.7,
		color: "Blue",
	...
	puradox: {
		num: -1993,
		name: "Puradox",
		baseForme: "Alive State",
		types: ["Normal"],
		baseStats: { hp: 78, atk: 91, def: 84, spa: 73, spd: 66, spe: 78 },
		abilities: { 0: "State Shift" },
		heightm: 0.2,
		weightkg: 5.9,
		color: "Blue",
		otherFormes: ["Puradox-Dead-State"],
		formeOrder: ["Puradox", "Puradox-Dead-State"],
		eggGroups: ["Field"],
	},
	puradoxdeadstate: {
		num: -1993,
		name: "Puradox-Dead-State",
		baseSpecies: "Puradox",
		forme: "Dead-State",
		types: ["Ghost"],
		baseStats: { hp: 78, atk: 73, def: 66, spa: 91, spd: 84, spe: 78 },
		abilities: { 0: "State Shift" },
		heightm: 0.2,
		weightkg: 5.9,
		color: "Purple",
	...
	jarmbat: {
		...
		name: "Jarmbat",
		types: ["Steel", "Ground"],
		baseStats: { hp: 86, atk: 65, def: 65, spa: 32, spd: 40, spe: 32 },
		abilities: { 0: "Steelworker", 1: "Battle Armor", H: "Thick Fat" },
		heightm: 0.8,
		weightkg: 27.2,
		color: "Gray",
		evos: ["Dvarmbat"],
		eggGroups: ["Humanlike", "Mineral"],
	},
	dvarmbat: {
		num: -1995,
		name: "Dvarmbat",
		types: ["Steel", "Ground"],
		baseStats: { hp: 104, atk: 85, def: 85, spa: 34, spd: 70, spe: 42 },
		abilities: { 0: "Steelworker", 1: "Battle Armor", H: "Thick Fat" },
		heightm: 0.9,
		weightkg: 54.4,
		color: "Gray",
	...
	dvarmith: {
		...
		name: "Dvarmith",
		types: ["Steel", "Ground"],
		baseStats: { hp: 126, atk: 105, def: 105, spa: 42, spd: 90, spe: 52 },
		abilities: { 0: "Steelworker", 1: "Battle Armor", H: "Thick Fat" },
		heightm: 1.8,
		weightkg: 140.6,
		color: "Gray",
		...
		evoItem: "Metal Coat",
		eggGroups: ["Humanlike", "Mineral"],
		otherFormes: ["Dvarmith-Mega"],
		formeOrder: ["Dvarmith", "Dvarmith-Mega"],
	},
	dvarmithmega: {
		num: -1996,
		name: "Dvarmith-Mega",
		baseSpecies: "Dvarmith",
		forme: "Mega",
		types: ["Steel", "Ground"],
		baseStats: { hp: 126, atk: 127, def: 130, spa: 42, spd: 127, spe: 68 },
		abilities: { 0: "Sheer Force" },
		heightm: 2.1,
		weightkg: 235.9,
		color: "Gray",
		eggGroups: ["Humanlike", "Mineral"],
		requiredItem: "Dvarmite",
	},
	lediboss: {
		num: -1997,
		name: "Lediboss",
		types: ["Bug", "Fighting"],
		baseStats: { hp: 90, atk: 115, def: 60, spa: 60, spd: 115, spe: 100 },
		abilities: { 0: "Swarm", 1: "Early Bird", H: "Iron Fist" },
		heightm: 1.6,
		weightkg: 58.9,
		color: "Red",
	...
	linturna: {
		...
		name: "Linturna",
		types: ["Water", "Electric"],
		baseStats: { hp: 140, atk: 63, def: 63, spa: 96, spd: 96, spe: 82 },
		abilities: { 0: "Volt Absorb", 1: "Illuminate", H: "Water Absorb" },
		heightm: 1.7,
		weightkg: 69.3,
		color: "Blue",
	...
	volstrika: {
		...
		name: "Volstrika",
		types: ["Electric", "Ground"],
		baseStats: { hp: 85, atk: 109, def: 67, spa: 86, spd: 67, spe: 126 },
	...
	fueghorn: {
		...
		name: "Fueghorn",
		types: ["Normal", "Fire"],
		baseStats: { hp: 82, atk: 97, def: 108, spa: 65, spd: 95, spe: 93 },
		abilities: { 0: "Fluffy", 1: "Steadfast", H: "Bulletproof" },
		heightm: 1.5,
		weightkg: 81.6,
		color: "White",
	...
	cuburn: {
		...
		name: "Cuburn",
		types: ["Ice", "Fire"],
		baseStats: { hp: 45, atk: 62, def: 38, spa: 62, spd: 38, spe: 55 },
		abilities: { 0: "Slush Rush", 1: "Strong Jaw", H: "Moxie" },
		heightm: 0.4,
		weightkg: 7.3,
		color: "Brown",
		evos: ["Taiburn"],
	...
	taiburn: {
		...
		name: "Taiburn",
		types: ["Ice", "Fire"],
		baseStats: { hp: 68, atk: 85, def: 51, spa: 80, spd: 51, spe: 75 },
		abilities: { 0: "Slush Rush", 1: "Strong Jaw", H: "Moxie" },
		heightm: 0.9,
		weightkg: 36.3,
		color: "Brown",
	...
	saburn: {
		...
		name: "Saburn",
		types: ["Ice", "Fire"],
		baseStats: { hp: 84, atk: 116, def: 71, spa: 98, spd: 71, spe: 90 },
		abilities: { 0: "Slush Rush", 1: "Strong Jaw", H: "Moxie" },
		heightm: 1.6,
		weightkg: 109.4,
		color: "Brown",
	...
	qinlong: {
		...
		name: "Qinlong",
		types: ["Dragon", "Rock"],
		baseStats: { hp: 43, atk: 48, def: 37, spa: 60, spd: 37, spe: 75 },
	...
	yinlong: {
		...
		name: "Yinlong",
		types: ["Dragon", "Rock"],
		baseStats: { hp: 61, atk: 70, def: 51, spa: 82, spd: 51, spe: 105 },
		abilities: { 0: "Clear Body", H: "Levitate" },
		heightm: 0.9,
		weightkg: 46.7,
		color: "Gray",
	...
	jinlong: {
		...
		name: "Jinlong",
		types: ["Dragon", "Rock"],
		baseStats: { hp: 95, atk: 100, def: 84, spa: 115, spd: 84, spe: 122 },
		abilities: { 0: "Golden Body", H: "Levitate" },
		heightm: 2.1,
		weightkg: 178.9,
		color: "Yellow",
		prevo: "Yinlong",
		evoLevel: 47,
		eggGroups: ["Dragon"],
		otherFormes: ["Jinlong-Mega"],
		formeOrder: ["Jinlong", "Jinlong-Mega"],
	},
	jinlongmega: {
		num: -2006,
		name: "Jinlong-Mega",
		...
		forme: "Mega",
		types: ["Dragon", "Rock"],
		baseStats: { hp: 95, atk: 110, def: 99, spa: 145, spd: 99, spe: 152 },
		abilities: { 0: "Golden Body" },
		heightm: 2.5,
		weightkg: 217.7,
		color: "Yellow",
		eggGroups: ["Dragon"],
		requiredItem: "Jinlongite",
	},
	azordin: {
		num: -2007,
		name: "Azordin",
		types: ["Dragon", "Ice"],
		gender: "N",
		baseStats: { hp: 95, atk: 110, def: 150, spa: 90, spd: 140, spe: 95 },
		abilities: { 0: "Stabilizing Order" },
		heightm: 6,
		weightkg: 245,
		color: "Blue",
		tags: ["Restricted Legendary"],
	...
	rokentro: {
		...
		types: ["Dragon", "Fire"],
		gender: "N",
		baseStats: { hp: 95, atk: 140, def: 90, spa: 150, spd: 110, spe: 95 },
		abilities: { 0: "Raging Chaos" },
		heightm: 6,
		weightkg: 235.8,
		color: "Red",
		tags: ["Restricted Legendary"],
	...
	coradios: {
		...
		types: ["Dragon", "Psychic"],
		gender: "N",
		baseStats: { hp: 140, atk: 125, def: 125, spa: 125, spd: 125, spe: 60 },
		abilities: { 0: "Balancing Aura" },
		heightm: 6.1,
		weightkg: 310,
		color: "Purple",
		tags: ["Restricted Legendary"],
	...
	faeolith: {
		...
		types: ["Ground", "Fairy"],
		gender: "N",
		baseStats: { hp: 135, atk: 58, def: 110, spa: 82, spd: 180, spe: 35 },
	...
	pyrotic: {
		...
		types: ["Fire", "Ghost"],
		gender: "N",
		baseStats: { hp: 105, atk: 75, def: 90, spa: 110, spd: 100, spe: 120 },
		abilities: { 0: "Prankster" },
		heightm: 1.6,
		weightkg: 68.2,
		color: "Red",
