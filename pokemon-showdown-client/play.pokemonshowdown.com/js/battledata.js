...
var CUSTOM_POKEMON_IDS=new Set([
...
'burrot','burthrow','larfluff','cocoonix','luminoth','bikkunise','snuffluff','snuffluffmega',
'kamakid','kamasei','stellopod','cephastar','celumina','whimsijack','tanukiroot','branuki',
'treenuki','rolil','rolidozer','volten','panthere','phantohm','phantohmmega','parapossum',
'charcupine','scorcupine','rattleghast','spectrattle','jabberoo','clobberoo','rootality','marling',
'martana','parkel','parktic','cluddle','adolem','adobalith','stalcria','stalpaca',
'embush','horeburn','eimole','treimor','cheimgar','alacruico','diablare','diablaze',
'cypup','cyprowl','apozip','apozoom','salaphyt','phyloch','torreloch','dustcoon',
'toxcoon','stegodite','stegeodon','obsidodile','obsidoruth','brawnsoon','brawnsoonflood','polterick',
'deceptjinn','bullectric','capacitaur','magnetaur','magnetaurmega','fridglet','frigidae','frigidaemega',
'chupacarno','spritanium','titanimaam','titanimaammega','chember','flaenix','infernoix','infernoixmega',
'toxila','gilagon','oracub','roaracle','roaraclemega','outlage','sileam','naiadance',
'naiphoria','puradox','puradoxdeadstate','jarmbat','dvarmbat','dvarmith','dvarmithmega','lediboss',
'linturna','volstrika','fueghorn','cuburn','taiburn','saburn','qinlong','yinlong',
'jinlong','jinlongmega','azordin','rokentro','coradios','faeolith','pyrotic','spearowazorian',
'fearowazorian','dragoniteazorian','hoppipazorian','skiploomazorian','jumpluffazorian','blisseyazorian','bouffalantazorian','dewpiderazorian',
'araquanidazorian','poliwrathmega','crobatmega','torkoalmega','flygonmega','roserademega','krookodilemega','crustlemega',
'hydreigonmega','aegislashmega','helioliskmega']
);

function isCustomPokemonSpriteId(id){
...
var spritePrefix=isCustomPokemonSpriteId(species.id)?Dex.getCustomSpritePrefix():Dex.resourcePrefix;
var spriteData={
gen:mechanicsGen,
w:96,
h:96,
...
var spritePrefix=isCustomPokemonSpriteId(data.spriteid)?
