...
_this=_PSRoom.call(this,options)||this;_this.team=void 0;_this.teamDeleted=false;_this.forceReload=false;_this.clientCommands=_this.parseClientCommands({'validate':function(target){if(this.team.format.length<=4){return this.errorReply("You must select a format first.");}this.send("/utm "+this.team.packedTeam);this.send("/vtm "+this.team.format);}});
var team=PS.teams.byKey[_this.id.slice(5)]||null;
_this.team=team;
_this.title="[Team] "+(((_this$team=_this.team)==null?void 0:_this$team.name)||'Not found');
