...
};return _this4;}_inheritsLoose(MainMenuPanel,_PSRoomPanel2);var _proto3=MainMenuPanel.prototype;_proto3.componentDidMount=function componentDidMount(){_PSRoomPanel2.prototype.componentDidMount.call(this);this.subscribeTo(PSBackground);};_proto3.focus=function focus(){var _this$base;(_this$base=this.base)==null||(_this$base=_this$base.querySelector('.formatselect'))==null||_this$base.focus();};_proto3.renderMiniRoom=function renderMiniRoom(room){return preact.h(PSPanelErrorBoundary,{key:room.id,room:room});};_proto3.
...
_this10.format=ev.target.value;
};_this10.
submit=function(ev,validate){var _window$BattleFormats2;
ev.preventDefault();
var format=_this10.format;

var teambuilderFormat=_this10.props.teamFormat||PS.teams.teambuilderFormat(format);
...
if(_this10.teraPreview){
var hasCustomRules=format.includes('@@@');
format=""+format+(hasCustomRules?', Tera Type Preview':'@@@ Tera Type Preview');
}
if(_this10.bestOf){var _this10$base;
var _hasCustomRules=format.includes('@@@');
var value=(_this10$base=_this10.base)==null||(_this10$base=_this10$base.querySelector('input[name=bestofvalue]'))==null?void 0:_this10$base.value;
format=""+format+(_hasCustomRules?", Best of = "+value:"@@@ Best of = "+value);
}
if(_this10.itemClause){
var _hasCustomRules2=format.includes('@@@');
format=""+format+(_hasCustomRules2?', Item Clause = 1':'@@@ Item Clause = 1');
}
...
if(rule==='itemclause=1')_this10.itemClause=checked;
};_this10.
...
render=function render(){var _this$props$defaultFo,_window$BattleFormats3,_window$BattleFormats4,_window$BattleFormats5;
...
this.props.selectType==='challenge'&&((_window$BattleFormats5=
window.BattleFormats[formatId])==null?void 0:_window$BattleFormats5.itemClauseDefault)&&preact.h("p",null,
preact.h("label",{"class":"checkbox"},
preact.h("input",{type:"checkbox",name:"itemclause",onChange:this.toggleCustomRule}),
preact.h("abbr",{title:"Start a battle with Item Clause"},"Item Clause"))),
