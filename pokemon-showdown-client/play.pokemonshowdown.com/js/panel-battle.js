...
rejoining=null;return _this4;}_inheritsLoose(BattleRoom,_ChatRoom);var _proto3=BattleRoom.prototype;_proto3.

interruptClose=function interruptClose(explicit,elem){var _this$users$PS$user$u;
if(!this.battle.ended&&(_this$users$PS$user$u=this.users[PS.user.userid])!=null&&_this$users$PS$user$u.startsWith('☆')&&!this.battle.isReplay){
...
_this5.receiveLine(['bigerror',"Battle \""+replayid+"\" not found"]);
_this5.receiveLine(['html',"<div class=\"broadcast-red pad\"><p class=\"buttonbar\"><button class=\"button\" data-cmd=\"/close\"><strong>Close</strong></button></p></div>"]
...
preact.h(ChatLog,{
"class":"battle-log hasuserlist",room:room,top:this.battleHeight,noSubscription:true,hasPreempt:true},
...
preact.h(BattleDiv,{room:room}),
preact.h(ChatLog,{
"class":"battle-log hasuserlist",room:room,left:640,noSubscription:true,hasPreempt:true}
