...
preact.h("p",null,
preact.h("input",{"class":"textbox",name:"statustext"}),
...
preact.h("option",{value:""},"Two panels (if wide enough)"),
...
preact.h("select",{name:"language",onChange:this.handleOnChange,"class":"button",value:serverSettings.language||'english'},
...
};return BattleTimerPanel;}(PSRoomPanel);BattleTimerPanel.id='battletimer';BattleTimerPanel.routes=['battletimer'];BattleTimerPanel.location='modal-popup';BattleTimerPanel.noURL=true;var
...
componentDidMount=function componentDidMount(){var _room$args11,_this20=this;
_PSRoomPanel19.prototype.componentDidMount.call(this);
var room=this.props.room;
var isWarn=((_room$args11=room.args)==null?void 0:_room$args11.type)==='warn';
if(isWarn){
room.closable=false;
var timerRef=setInterval(function(){
var timeLeft=_this20.state.timeLeft;
if(timeLeft===1){
clearInterval(_this20.state.timerRef);
_this20.setState({canClose:true,timeLeft:0,timerRef:null});
}else{
_this20.setState({canClose:false,timeLeft:timeLeft-1});
}
},1000);
...
render=function render(){var _room$args12,_room$args13,_room$args14;
var room=this.props.room;
var type=(_room$args12=room.args)==null?void 0:_room$args12.type;
var isWarn=type==='warn';
var message=((_room$args13=room.args)==null?void 0:_room$args13.message)||'';
return preact.h(PSPanelWrapper,{room:room,width:((_room$args14=room.args)==null?void 0:_room$args14.width)||780},
