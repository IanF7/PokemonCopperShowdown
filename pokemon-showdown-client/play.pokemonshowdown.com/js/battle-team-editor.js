...
setFocus=function(ev){var _editor$innerFocus;
...
var type=rawType;
if(!target.value||((_editor$innerFocus=editor.innerFocus)==null?void 0:_editor$innerFocus.setIndex)===setIndex&&editor.innerFocus.type===type){
...
keyDownSearch=function(ev){var _editor$innerFocus2;
var searchBox=ev.currentTarget;
var editor=_this9.props.editor;
switch(ev.keyCode){
case 8:
...
if(((_editor$innerFocus2=editor.innerFocus)==null?void 0:_editor$innerFocus2.type)!=='move')searchBox.value=value||'';
if(value!==null){var _editor$innerFocus3;
if(ev.keyCode===9&&((_editor$innerFocus3=editor.innerFocus)==null?void 0:_editor$innerFocus3.type)==='move'){
_this9.changeFocus({
setIndex:editor.innerFocus.setIndex,
type:ev.shiftKey?'item':'stats'
});
}else{var _editor$innerFocus4;
var _value$split=value.split('|'),name=_value$split[0],moveSlot=_value$split[1];
_this9.selectResult(((_editor$innerFocus4=editor.innerFocus)==null?void 0:_editor$innerFocus4.type)||'',name,moveSlot,ev.keyCode===9&&ev.shiftKey);
}
}else{
_this9.clearSearchBox();
editor.setSearchValue('');
...
if((searchBox==null?void 0:searchBox.name)==='value'){
if(filters){
...
var _editor$innerFocus6=editor.innerFocus,type=_editor$innerFocus6.type,setIndex=_editor$innerFocus6.setIndex;
...
type:"number",inputMode:"numeric","class":"textbox default-placeholder",onInput:_this13.changeIV,
onChange:_this13.changeIV}
)),
...
preact.h("select",{name:"nature","class":"button",onChange:this.changeNature,value:set.nature||'Serious'},
