...
renderControls=function renderControls(){var _room$args,_PS$connection2;
var room=this.props.room;
...
((_PS$connection2=PS.connection)==null?void 0:_PS$connection2.reconnectTimer)&&preact.h("small",null,"(Autoreconnect in ",Math.round(PS.connection.reconnectDelay/1000),"s)")
)
);
};_proto5.
...
ChatLog=function(_preact$Component6){function ChatLog(){var _this13;for(var _len5=arguments.length,args=new Array(_len5),_key5=0;_key5<_len5;_key5++){args[_key5]=arguments[_key5];}_this13=_preact$Component6.call.apply(_preact$Component6,[this].concat(args))||this;_this13.



subscription=null;return _this13;}_inheritsLoose(ChatLog,_preact$Component6);var _proto8=ChatLog.prototype;_proto8.
