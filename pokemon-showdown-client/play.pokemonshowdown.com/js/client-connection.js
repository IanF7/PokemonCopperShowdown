...
function PSConnection(){var _this=this;this.socket=null;this.connected=false;this.lastMessageTimeBeforeReconnect=0;this.queue=[];this.reconnectDelay=1000;this.reconnectCap=15000;this.shouldReconnect=true;this.reconnectTimer=null;this.worker=null;
...
_this2.lastMessageTimeBeforeReconnect=parseInt(PS.lastMessageTime)||0;
...
_this3.lastMessageTimeBeforeReconnect=parseInt(PS.lastMessageTime)||0;
