...
// Pokemon Copper custom moves: reuse the animation of the closest official
// move (same type, and same style of attack). Without an entry here a move
// falls back to Tackle's animation.
BattleMoveAnims['darkwave'] = { anim: BattleMoveAnims['snarl'].anim };
BattleMoveAnims['blitz'] = { anim: BattleMoveAnims['spark'].anim };
BattleMoveAnims['powersurge'] = { anim: BattleMoveAnims['thunder'].anim };
BattleMoveAnims['thunderslash'] = { anim: BattleMoveAnims['thunderpunch'].anim };
BattleMoveAnims['faestrike'] = { anim: BattleMoveAnims['playrough'].anim };
BattleMoveAnims['pixiepunch'] = { anim: BattleMoveAnims['spiritbreak'].anim };
BattleMoveAnims['scorchingblade'] = { anim: BattleMoveAnims['bitterblade'].anim };
BattleMoveAnims['pressurewave'] = { anim: BattleMoveAnims['airslash'].anim };
BattleMoveAnims['spectralstrike'] = { anim: BattleMoveAnims['shadowclaw'].anim };
BattleMoveAnims['vengeance'] = { anim: BattleMoveAnims['shadowforce'].anim };
BattleMoveAnims['haunt'] = { anim: BattleMoveAnims['infestation'].anim };
BattleMoveAnims['seismicbeam'] = { anim: BattleMoveAnims['earthpower'].anim };
BattleMoveAnims['frostbite'] = { anim: BattleMoveAnims['icefang'].anim };
BattleMoveAnims['telekineticslam'] = { anim: BattleMoveAnims['psychic'].anim };
BattleMoveAnims['crystallinecannon'] = { anim: BattleMoveAnims['powergem'].anim };
BattleMoveAnims['mineralburst'] = { anim: BattleMoveAnims['flashcannon'].anim };
BattleMoveAnims['metalpulse'] = { anim: BattleMoveAnims['flashcannon'].anim };
BattleMoveAnims['thorntrap'] = { anim: BattleMoveAnims['powerwhip'].anim };
BattleMoveAnims['counterspine'] = { anim: BattleMoveAnims['needlearm'].anim };
BattleMoveAnims['blazingsprint'] = { anim: BattleMoveAnims['flamecharge'].anim };
BattleMoveAnims['hydrosmash'] = { anim: BattleMoveAnims['wavecrash'].anim };
BattleMoveAnims['heist'] = { anim: BattleMoveAnims['thief'].anim };
BattleMoveAnims['spookyserenade'] = { anim: BattleMoveAnims['hypervoice'].anim };
BattleMoveAnims['staticsurprise'] = { anim: BattleMoveAnims['wildcharge'].anim };
BattleMoveAnims['recklessroll'] = { anim: BattleMoveAnims['steamroller'].anim };
BattleMoveAnims['quillbarrage'] = { anim: BattleMoveAnims['pinmissile'].anim };
BattleMoveAnims['crushingkick'] = { anim: BattleMoveAnims['highjumpkick'].anim };
BattleMoveAnims['guidingflame'] = { anim: BattleMoveAnims['ember'].anim };
BattleMoveAnims['aquaticrush'] = { anim: BattleMoveAnims['surf'].anim };
BattleMoveAnims['vampiricbite'] = { anim: BattleMoveAnims['crunch'].anim };
BattleMoveAnims['psybarrage'] = { anim: BattleMoveAnims['psybeam'].anim };
BattleMoveAnims['sandbullet'] = { anim: BattleMoveAnims['mudshot'].anim };
BattleMoveAnims['flowingdance'] = { anim: BattleMoveAnims['waterpulse'].anim };
BattleMoveAnims['armorforge'] = { anim: BattleMoveAnims['irondefense'].anim };
BattleMoveAnims['grenegg'] = { anim: BattleMoveAnims['eggbomb'].anim };
BattleMoveAnims['insectoidrush'] = { anim: BattleMoveAnims['armthrust'].anim };
BattleMoveAnims['shortcircuit'] = { anim: BattleMoveAnims['bubblebeam'].anim };
BattleMoveAnims['lightningdash'] = { anim: BattleMoveAnims['extremespeed'].anim };
BattleMoveAnims['scaldinghorn'] = { anim: BattleMoveAnims['megahorn'].anim };
BattleMoveAnims['flashfreeze'] = { anim: BattleMoveAnims['icepunch'].anim };
BattleMoveAnims['goldenstorm'] = { anim: BattleMoveAnims['makeitrain'].anim };
BattleMoveAnims['orderstrike'] = { anim: BattleMoveAnims['dragonclaw'].anim };
BattleMoveAnims['chaoticburst'] = { anim: BattleMoveAnims['dragonpulse'].anim };
BattleMoveAnims['equilibriumpulse'] = { anim: BattleMoveAnims['clangingscales'].anim };
BattleMoveAnims['mysticward'] = { anim: BattleMoveAnims['lightscreen'].anim };
BattleMoveAnims['dancingflames'] = { anim: BattleMoveAnims['fierydance'].anim };
